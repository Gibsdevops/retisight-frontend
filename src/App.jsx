...
import LiveConsultAgora from './components/LiveConsultAgora';
...
const PatientDashboard = ({ onLogout }) => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col font-sans antialiased text-slate-900 text-left">
      <PatientNavbar activeTab={activeTab} setActiveTab={setActiveTab} onLogout={onLogout} />
        ...
        <AnimatePresence mode="wait">
          ...
          {activeTab === 'consult' && (
            <motion.div key="c" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              <LiveConsultAgora appointmentId="test-123" userRole="patient" />
            </motion.div>
          )}
        </AnimatePresence>
      </main>
